      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-3 2xl:-right-40 w-80 sm:w-96 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl shadow-2xl overflow-hidden z-50"
          >
